 ...
 */
    ...
    */
    ...
    /**
     *  An invitation was received. The invitation can be accepted using 
     *  #vp_invite_accept or declined using #vp_invite_decline
     *
     *  Attributes:
     *  - #VP_INVITE_ID
     *  - #VP_INVITE_WORLD
...
typedef enum vp_float_attribute_t
{
	 ...
	 */
	VP_OBJECT_PITCH = VP_OBJECT_ROTATION_X,
	/**
	 * Only works correctly when #VP_OBJECT_ROTATION_ANGLE is set to infinity
	 * \deprecated Use #VP_OBJECT_ROTATION_X, #VP_OBJECT_ROTATION_Y, #VP_OBJECT_ROTATION_Z and #VP_OBJECT_ROTATION_ANGLE
	 */
	VP_OBJECT_YAW = VP_OBJECT_ROTATION_Y,
	/**
	 * Only works correctly when #VP_OBJECT_ROTATION_ANGLE is set to infinity
	 * \deprecated Use #VP_OBJECT_ROTATION_X, #VP_OBJECT_ROTATION_Y, #VP_OBJECT_ROTATION_Z and #VP_OBJECT_ROTATION_ANGLE
	 */
...
VPSDK_API int vp_invite(vp_instance_t instance, int user_id, const char* world, double x, double y, double z, float yaw, float pitch);
VPSDK_API int vp_invite_accept(vp_instance_t instance, int invitation_id);
VPSDK_API int vp_invite_decline(vp_instance_t instance, int invitation_id);
